define(['jquery', 'underscore'], function ($, _) {
  ...
  if (!!Modernizr) {
    $(window).on(
      ...
      _.debounce(function () {
        ...
        var $mainMenuContainer = $('.main-navigation');
  ...
  function addDropdownButtonsToMenuItems($mainMenuContainer) {
    ...
    $mainMenuContainer
      .find('.menu-item-has-children > button.dropdown-toggle')
      .on('click.tdm', function (ev) {
        ev.preventDefault();
